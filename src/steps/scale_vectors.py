...
class ScaleVectorsStep(Step):
    ...
    def run(self, data: dict) -> dict:
        ...
        logging.info(f"Scaling vectors in column '{self.target_column}' using {self.method} scaler...")
        ...
        logging.info(f"Scaling complete. Scaled vectors stored in column '{self.output_column}'.")
        return data
